...
private val DarkColorScheme = darkColorScheme(
    ...
    surfaceVariant = DarkPink40,
    onSurfaceVariant = Color.White
)

private val LightColorScheme = lightColorScheme(
    primary = VioletaFuerte,
    onPrimary = Color.White,
    secondary = PurpleGrey40,
    tertiary = LowYellow,
    onTertiary = BlackPurple,
    tertiaryContainer = Yellow,
    background = Color.White,
    surface = Color.White,
    onBackground = BlackPurple,
    onSurface = BlackPurple,
    surfaceVariant = Pink40,
    onSurfaceVariant = BlackPurple
)
...
fun SplitMouseTheme(
    ...
    // Disabled by default to prioritize our custom palette
